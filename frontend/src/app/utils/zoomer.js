...
export function zoom_in(anchor, x_domain, y_domain, canvas_domain, factor = 1.5){
    ...
    x_domain[0] = anchor[0] - x_left   / factor;
    x_domain[1] = anchor[0] + x_right  / factor;
    y_domain[0] = anchor[1] + y_top    / factor;
    y_domain[1] = anchor[1] - y_bottom / factor;
    return {
        x_dom : x_domain,
        y_dom : y_domain,
    }
}
export function zoom_out(anchor, x_domain, y_domain, canvas_domain, factor = 1.5){
    anchor = transform(x_domain, y_domain, canvas_domain, anchor[0], anchor[1]);
